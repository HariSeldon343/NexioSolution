        ...
        <div class="events-grid">
            ...
            <div class="event-card">
                ...
                <div class="event-info">
                    <?php if (!$currentAzienda && $auth->isSuperAdmin() && isset($evento['nome_azienda'])): ?>
                    <div class="info-item">
                        <i>🏢</i>
                        <span><?php echo htmlspecialchars($evento['nome_azienda']); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="info-item">
                        <i>📅</i>
                ...
                <div class="event-actions">
                    ...
                    $stmt_check = $db->getConnection()->prepare("SELECT * FROM evento_partecipanti WHERE evento_id = ? AND utente_id = ?");
                ...
                <div class="hour-slot">
                    ...
                    <div class="hour-events">
                        <div class="event-detail-box">
                            ...
                            <?php if (!$currentAzienda && $auth->isSuperAdmin() && isset($evento['nome_azienda'])): ?>
                                <p style="margin: 5px 0; color: #9333ea; font-size: 14px; font-weight: 500;">
                                    <i>🏢</i> <?php echo htmlspecialchars($evento['nome_azienda']); ?>
                                </p>
                            <?php endif; ?>
                            <?php if ($evento['luogo']): ?>
